...
MY_TOKENS="10000000000000000000000abcx"
...
cat $HOME/.blockxd/config/genesis.json | jq '.genesis_time = "2024-01-10T12:00:00.0Z"' > $HOME/.blockxd/config/tmp_genesis.json && mv $HOME/.blockxd/config/tmp_genesis.json $HOME/.blockxd/config/genesis.json
